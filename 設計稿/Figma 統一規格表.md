...
| 類別 | Font family | Weight | Size | Color | Opacity |
|---|---|---|---|---|---|
...
| 狀態 | Fill（底色） | Text（文字） |
|---|---|---|
| 開始（Start） | #14CE75（100%） | Lexend；#FFFFFF（100%） |
| 結束（End） | #FF0000（100%） | Lexend；#FFFFFF（100%） |
...
| Fill（未選擇） | #FFFFFF（100%） |
| Fill（已選擇） | #737373（100%） |
| 內容圖片（Content Image） | 依實際內容配置 |
| Effects（Drop shadow） | Position：x=6, y=6；Blur：10；Spread：0；Color：#000000（25%） |

## 小按鈕（增加、回上頁等 Small Icon Button）
...
| Stroke | Color：#E6E6E6（100%）；Position：Inside；Width：1px |
| Effects（Drop shadow） | Position：x=6, y=6；Blur：10；Spread：0；Color：#000000（25%） |
...
| 尺寸 | W 30 × H 30 |
| Color | #000000（100%） |
| Stroke | Color：#000000（100%）；Position：Center；Width：1px |
